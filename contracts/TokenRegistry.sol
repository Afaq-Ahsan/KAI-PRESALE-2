...
abstract contract TokenRegistry is Ownable2Step {
    ...
    /// @custom:priceFeed The address of Chainlink price feed contract for the token
    /// @custom:normalizationFactorForToken The normalization factor to achieve return value of
    /// 18 decimals ,while calculating token purchases and always with different token decimals
    /// @custom:tolerance The tolerance percentage for the price feed value, with 2 decimals
