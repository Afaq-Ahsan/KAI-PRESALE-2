...
import {
    ...
    DiscountUpdatedForUpperLimit as DiscountUpdatedForUpperLimitEvent,
    GemsRoundLimitUpdated as GemsRoundLimitUpdatedEvent,
    LowerLimitUpdated as LowerLimitUpdatedEvent,
    ...
    SpecialRoundLimitUpdated as SpecialRoundLimitUpdatedEvent,
    TokenDataAdded as TokenDataAddedEvent,
    TokensAccessUpdated as TokensAccessUpdatedEvent,
    UpperLimitUpdated as UpperLimitUpdatedEvent
} from '../generated/PreSale/PreSale';
import {
    BlacklistUpdated,
    BurnWalletUpdated,
    BuyEnableUpdated,
    DiscountUpdatedForUpperLimit,
    GemsRoundLimitUpdated,
    LowerLimitUpdated,
...
export function handleBurnWalletUpdated(event: BurnWalletUpdatedEvent): void {
    let entity = new BurnWalletUpdated(event.transaction.hash.concatI32(event.logIndex.toI32()));
...
export function handlePlatformWalletUpdated(event: PlatformWalletUpdatedEvent): void {
    let entity = new PlatformWalletUpdated(event.transaction.hash.concatI32(event.logIndex.toI32()));
...
export function handleProjectWalletUpdated(event: ProjectWalletUpdatedEvent): void {
    let entity = new ProjectWalletUpdated(event.transaction.hash.concatI32(event.logIndex.toI32()));
...
export function handlePurchasedWithClaimAmount(event: PurchasedWithClaimAmountEvent): void {
    let entity = new PurchasedWithClaimAmount(event.transaction.hash.concatI32(event.logIndex.toI32()));
    ...
    if (event.params.tokenPurchased == BigInt.fromI32(0)) {
        ...
        if (event.params.token.toHexString() == LINK || event.params.token.toHexString() == ETH) {
...
export function handlePurchasedWithETH(event: PurchasedWithETHEvent): void {
    let entity = new PurchasedWithETH(event.transaction.hash.concatI32(event.logIndex.toI32()));
    entity.by = event.params.by;
...
export function handlePurchasedWithToken(event: PurchasedWithTokenEvent): void {
    let entity = new PurchasedWithToken(event.transaction.hash.concatI32(event.logIndex.toI32()));
    entity.token = event.params.token;
    entity.tokenPrice = event.params.tokenPrice;
    entity.by = event.params.by;
    entity.code = event.params.code;
...
export function handleRoundCreated(event: RoundCreatedEvent): void {
    let entity = new RoundCreated(event.transaction.hash.concatI32(event.logIndex.toI32()));
...
export function handleRoundUpdated(event: RoundUpdatedEvent): void {
    let entity = new RoundUpdated(event.transaction.hash.concatI32(event.logIndex.toI32()));
    entity.round = event.params.round;
    entity.roundData_startTime = event.params.roundData.startTime;
    entity.roundData_endTime = event.params.roundData.endTime;
    entity.roundData_price = event.params.roundData.price;
...
export function handleTokenDataAdded(event: TokenDataAddedEvent): void {
    let entity = new TokenDataAdded(event.transaction.hash.concatI32(event.logIndex.toI32()));
    entity.token = event.params.token;
    entity.data_priceFeed = event.params.data.priceFeed;
    entity.data_normalizationFactorForToken = event.params.data.normalizationFactorForToken;
...
export function handleTokensAccessUpdated(event: TokensAccessUpdatedEvent): void {
    let entity = new TokensAccessUpdated(event.transaction.hash.concatI32(event.logIndex.toI32()));
    entity.round = event.params.round;
    entity.token = event.params.token;
...
export function handleGemsRoundLimitUpdated(event: GemsRoundLimitUpdatedEvent): void {
    let entity = new GemsRoundLimitUpdated(event.transaction.hash.concatI32(event.logIndex.toI32()));
...
export function handleLowerLimitUpdated(event: LowerLimitUpdatedEvent): void {
    let entity = new LowerLimitUpdated(event.transaction.hash.concatI32(event.logIndex.toI32()));
...
export function handleUpperLimitUpdated(event: UpperLimitUpdatedEvent): void {
    let entity = new UpperLimitUpdated(event.transaction.hash.concatI32(event.logIndex.toI32()));
...
export function handleDiscountUpdatedForUpperLimit(event: DiscountUpdatedForUpperLimitEvent): void {
    let entity = new DiscountUpdatedForUpperLimit(event.transaction.hash.concatI32(event.logIndex.toI32()));

    entity.oldDiscount = event.params.oldDiscount;
...
export function handleSpecialRoundLimitUpdated(event: SpecialRoundLimitUpdatedEvent): void {
    let entity = new SpecialRoundLimitUpdated(event.transaction.hash.concatI32(event.logIndex.toI32()));
